...
export type mm_usersCreationAttributes = Optional<
  mm_usersAttributes,
  mm_usersOptionalAttributes
>;

export class mm_users
  extends Model<mm_usersAttributes, mm_usersCreationAttributes>
  implements mm_usersAttributes
{
  address!: string;
  createdAt?: Date;
  updatedAt?: Date;
